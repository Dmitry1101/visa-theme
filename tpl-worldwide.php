...
<?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>
		...
		<div class="jumbo jumbo-2 flexx flexx-wrap" style="background: url('<?php bloginfo("template_directory");?>/dist/img/jumbo-6.jpg') center bottom no-repeat; background-attachment: fixed;">
			<div class="jumbo-2__txt">
				<h1>Countries Visa Requirements</h1>
				<p>
					Our absolute guide on countries visa requirements
				</p>
			</div>
		</div>
		...
		<div class="mainn s content">
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						<div class="sect-title under under-2 page-title">Visa Requirements</div>
					</div>
				</div>
